...
def run(playwright: Playwright) -> None:
    ...
    page.get_by_role("textbox", name="Email Address *").fill("jcschill12@gmail.com")
    ...
    page.locator("#epl-email-aodrsmzfpyxdet0hvraigenblock388c186ytkrd9").fill("jcschill12@gmail.com")
