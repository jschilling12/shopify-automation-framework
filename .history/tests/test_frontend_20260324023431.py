...
# World Cup Team
text_teamname=TEXT_TEAMNAME = 'USA'

# Dropdown for Premier League team
dropdown=DROPDOWN = 'Arsenal'
email=EMAIL = 'fakeeamil@gmail.com'
num=NUM = '1'
exp=EXP = '03/30'
sec=SEC = '111'
name=NAME = '1'
first=FIRST = 'Jordan'
last=LAST = 'Schilling'
customer_address=CUSTOMER_ADDRESS = '111'

# Selection for address dropdown
customer_address_options=CUSTOMER_ADDRESS_OPTIONS = '111 North Orange Ave'
