...
class AddToCartPage:
    ...
    def input_email_promo(self, email):
        ...
        self.page.locator("#epl-email-aodrsmzfpyxdet0hvraigenblock388c186ytkrd9").fill(email)
    ...
    def add_to_cart(self, email, text_teamname, dropdown):
        self.select_input()
        self.input_email(email)
        self.input_team(text_teamname)
        self.select_input_promo()
        self.input_email_promo(email)
        self.select_team(dropdown)