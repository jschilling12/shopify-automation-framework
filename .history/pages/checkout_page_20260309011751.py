...
class CheckoutProcess:
    def __init__(self, page:Page):
        ...
        self.card_number = page.locator("iframe[name=\"card-fields-number-aiyoujmtrag00000\"]").content_frame.get_by_role("textbox", name="Card number")
        self.exp_date =  page.locator("iframe[name=\"card-fields-expiry-sx1kl7or7p000000\"]").content_frame.get_by_role("textbox", name="Expiration date (MM / YY)")
        self.sec_code = page.locator("iframe[name=\"card-fields-verification_value-pisl5quxhx800000\"]").content_frame.get_by_role("textbox", name="Security code")
        self.card_name = page.locator("iframe[name=\"card-fields-name-s9t0rmbbdkq00000\"]").content_frame.get_by_role("textbox", name="Name on card")
